...
btnSubmit.addEventListener("click", function () {
  ...
  grecaptcha.ready(function () {
    grecaptcha.execute("6LdmnDMkAAAAAG4dAz32VMYBav7jVwyrPwz-0sA1", {
      action: "submit"
    }).then(function (token) {
      ...
      fetch("http://localhost:3001/contact", {
        ...
        successMessage.innerHTML = "Errore! API non disponibile, riprova più tardi.";
        successMessage.classList.add("visible");
        loadingSpinner.classList.add("d-none");
...
function changeStep(step) {
  var currentStep = parseInt(form.getAttribute("data-step"));
  if (step == "next") {
...
/* harmony import */ var _dark_mode__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dark-mode */ "./src/dark-mode.js");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmirkoalba_github_io"] = self["webpackChunkmirkoalba_github_io"] || [];
